...
public class Battleship2 {
	...
	public void startBtn() {
		...
		if (result.isPresent()) {
			...
			dialog.setContentText("Select the first coordinate for your carrier:");
...
//							for (int x = 0; x < 5; x++) {
//								if (boards[0].getCells()[carrierX - x][carrierY].getCellState() == cellState.SHIP) {
//									isValid = false;
//								}
//							}
							break;
